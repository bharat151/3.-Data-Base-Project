...
<html lang="en" dir="ltr">
  ...
  <body onload='firstLoad()'>
    ...
    <div class="container">
      <table id='listItem' border style="width: 100%; font-size: 25px;">
        <thead align='center'>
          <th>Items</th>
          <th>Price</th>
        </thead>
      </table>
        <button onclick="submitBtn()" class="btn btn-success" style="height: 50px; font-size: 20px;width:100%;" >PAY NOW !!</button>
    </div>
